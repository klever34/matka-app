...
const HowtPlay = (props) => {
    return (
        ...
        <View style={styles.areahow}>
            ...
            <Text>{`\n`}</Text>
            <Text style={styles.listitem}>1. Withdrawal and  deposit min 200 Point.</Text>
            <Text>{`\n`}</Text>
            <Text style={styles.listitem}>2. send screenshot in whatsapp after deposit.</Text>
            <Text>{`\n`}</Text>
            <Text style={styles.listitem}>3. Point will be added within 10 minutes of deposit.</Text>
            <Text>{`\n`}</Text>
            <Text style={styles.listitem}>4. Withdrawal request time 11.30am to 3.00pm</Text>
            <Text>{`\n`}</Text>
            <Text style={styles.listitem}>5. Request process may takes upto 30 minutes and Point will be transferred to account-phonepe-paytm-google pay-whichever is registered by you with us.</Text>
            <Text>{`\n`}</Text>
        ...
        <View style={styles.areahow}>
            ...
            <Text>{`\n`}</Text>
            <Text style={styles.listitem}>1. निकासी और जमा 200 मिनट।.</Text>
            <Text>{`\n`}</Text>
            <Text style={styles.listitem}>2. जमा करने के बाद व्हाट्सएप में स्क्रीनशॉट भेजें।.</Text>
            <Text>{`\n`}</Text>
            <Text style={styles.listitem}>3. डिपॉजिट जमा होने के 10 मिनट के भीतर जुड़ जाएगा।</Text>
            <Text>{`\n`}</Text>
